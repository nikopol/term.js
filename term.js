...
*/
  ...
  function termobj(usrcfg){
    ...
    var
      ...
      vars=$.extend({}, DFTVARS, usrcfg.vars),
      cfg={
        format: 'html',
      ...
      mod, tools, formats, core, output, input;
    ...
    input=(function(){
      ...
      return {
        ...
        prompt: function(ps1){
          ...
          $prompt.html(tools.style(tools.eval(p)));
          show();
        },
...
*/
    ...
    core=(function(){
      ...
      return {
        ...
        exec: function(cmd){
          ...
          if( cfg.exec )
            p=cfg.exec.call(this,cmd,p);
          else if( mod.exec )
            p=mod.exec.call(this,cmd,p);
          else {
            p=$.Deferred();
            p.resolve();
          }
    ...
    usrcfg.init && usrcfg.init.call(this);
    vars.hello && output.echo(tools.evals(vars.hello));
    usrcfg.mod && mod && output.echo('<grey>module '+usrcfg.mod+' '+(mod.version || '')+' loaded');
